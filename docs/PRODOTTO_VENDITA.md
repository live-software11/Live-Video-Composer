...
> **Indice canonico aggiornato:** vedi [`README.md`](./README.md) (entry-point post 6 maggio 2026, riferisce `AGENTS.md` / `CLAUDE.md` / `ARCHITETTURA`).

| File | Contenuto |
|------|-----------|
| `../AGENTS.md` | Entry-point standard 2026 per agenti AI (Cursor / Codex / Continue) |
| `../CLAUDE.md` | Sintesi viva per Claude Desktop / Code |
| `ARCHITETTURA_Live_Video_Composer.md` | Documento unico di riferimento (stack, data model, export, flussi) |
| `Istruzioni_Progetto_Claude_Live_Video_Composer.md` | Istruzioni progetto per Claude Desktop (legacy) |
| `Primo_Prompt_Avvio_Chat_Claude_Desktop_Live_Video_Composer.md` | Prompt avvio chat Claude Desktop (legacy) |
