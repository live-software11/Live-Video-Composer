...
_TRANSLATIONS = {
    "it": {
        ...
        "bg.transparent_hint": "Canale alpha vero solo in export PNG/WebP (overlay per vMix Titles/Resolume). JPG, BMP e video restano sempre opachi.",
        "bg.black": "Nero",
        "bg.white": "Bianco",
        "bg.gray": "Grigio",
        "bg.red": "Rosso",
        ...
        "export_img.dpi": "DPI: {0} | Compressione: {1}%",
        # Export Video
        "export_vid.title": "▷ Esporta Video",
        "export_vid.title_disabled": "🎬 Esporta Video (nessun video)",
        "export_vid.format": "Formato:",
        "export_vid.format_hint": "AVI (MJPEG): vMix/Resolume, seek istantaneo. MP4 (H.264): distribuzione/archivio.",
        "export_vid.fps": "FPS:",
        "export_vid.quality": "Qualità:",
        "export_vid.btn": "▶ ESPORTA VIDEO",
        "export_vid.bitrate": "Qualità gestita dal codec del sistema (non regolabile)",
        # Cancel
    ...
    "en": {
        ...
        "bg.transparent_hint": "Real alpha channel only in PNG/WebP export (overlay for vMix Titles/Resolume). JPG, BMP and video stay always opaque.",
        "bg.black": "Black",
        "bg.white": "White",
        "bg.gray": "Gray",
        "bg.red": "Red",
        ...
        "export_img.dpi": "DPI: {0} | Compression: {1}%",
        "export_vid.title": "▷ Export Video",
        "export_vid.title_disabled": "🎬 Export Video (no video)",
        "export_vid.format": "Format:",
        "export_vid.format_hint": "AVI (MJPEG): vMix/Resolume, instant seek. MP4 (H.264): distribution/archive.",
        "export_vid.fps": "FPS:",
        "export_vid.quality": "Quality:",
        "export_vid.btn": "▶ EXPORT VIDEO",
        "export_vid.bitrate": "Quality is handled by the system codec (not adjustable)",
